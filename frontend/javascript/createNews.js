...
document.querySelector("#add-keyword").addEventListener("click", function () {
	console.log("cliquei em add keyword");
...
document
	...
	.addEventListener("click", function () {
		console.log("cliquei em add membro associado");
...
function createNews() {
	...
	console.log(memberString + "após o includes");
	...
	if (title != "" && photo != "" && description != "" && keywordString != "") {
		...
		let path = defaulPath + "news/insertNews";
